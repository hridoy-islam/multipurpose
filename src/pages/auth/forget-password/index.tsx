...
export default function ForgotPassword() {
  ...
  return (
    <>
      <div className="container pt-20  h-svh items-center justify-center bg-primary bg-sky-50 lg:max-w-none lg:px-0">
        <div className='w-8/12 mx-auto shadow-2xl flex p-5'>
          ...
          <div className="mx-auto flex w-full flex-col justify-center space-y-2 sm:w-[480px] lg:p-8">
            <div className="mb-4 flex items-center justify-center">
              ...
              <h3 className="text-4xl font-bold text-supperagent">Recruitment</h3>
            </div>
            <Card className="p-6">
