            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  ...
                  {currentStep === 'review' && 'Review and edit Invoice details'}
                  {currentStep === 'finalized' && 'Invoice has been successfully generated'}
                </p>
              </div>
            </div>
            {currentStep === 'create' && (
          ...
          <div className="max-w-2xl mx-auto">
            <Card>
              <CardHeader className="text-center">
                ...
                <CardTitle className="text-2xl text-green-900">Invoice Generated Successfully!</CardTitle>
                <CardDescription>
                  The Invoice for {selectedUser?.name} has been created and saved.
                </CardDescription>
              </CardHeader>
